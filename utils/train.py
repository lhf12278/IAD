...
from solver import make_optimizer1,make_optimizer_Attack,WarmupMultiStepLR
...
if __name__ == '__main__':
    ...
    output_dir = osp.join(cfg.OUTPUT_DIR, str(cfg.DATASETS.NAMES[0]) + '+' + str(cfg.DATASETS.NAMES[1]) + '+' + str(cfg.DATASETS.NAMES[2]) + '->' + str(cfg.DATASETS.NAMES_TARGET[0]))
    attack_dir = osp.join(cfg.ATTACK_DIR, str(cfg.DATASETS.NAMES[0]) + '+' + str(cfg.DATASETS.NAMES[1]) + '+' + str(cfg.DATASETS.NAMES[2]) +'->' + str(cfg.DATASETS.NAMES_TARGET[0]))
    ...
    # scheduler_DG_Net2 = create_scheduler(cfg, optimizer_DG_Net2)
    ...
    do_train(
        ...
        loss_func,
        num_query, args.local_rank,num_classes,output_dir
    )
