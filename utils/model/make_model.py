...
def make_model(cfg, num_class, camera_num, view_num):
    ...
    model1 = build_transformer(num_class, camera_num, view_num, cfg, __factory_T_type)
    model2 = build_transformer(num_class, camera_num, view_num, cfg, __factory_T_type)
