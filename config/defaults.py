...
_C.PARA = CN()
_C.PARA.RATO = 0.5
# _C.PARA.TARGET_POS = -0.75
# _C.PARA.TARGET_NEG = 0.75
# _C.PARA.T = 0.65
# _C.PARA.LANBUDA = 2.0
_C.PARA.TRAIN_DG_Net = 3
_C.PARA.ASG_LANBUDA = 1.0
_C.PARA.TRAIN_Attack_Net = 3
...
_C.DATASETS.NAMES_TARGET = ['market1501']
