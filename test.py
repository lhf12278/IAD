...
if __name__ == "__main__":
    ...
    train_loader, train_loader_normal, val_loader, num_query, num_classes, camera_num, view_num,T = make_dataloader(cfg)
    ...
    DG_Net.E.load_state_dict(torch.load(cfg.TEST.WEIGHT), strict=False)
    # DG_Net.E1.load_state_dict(torch.load(cfg.TEST.WEIGHT), strict=False)
    # DG_Net1.load_param(cfg.TEST.WEIGHT)
